# Generated by Powerlevel10k configuration wizard on 2023-10-08 at 01:03 WEST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 42599.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# 24h time, round separators, blurred heads, round tails, 2 lines, dotted, right frame,
# darkest-ornaments, compact, few icons, fluent, transient_prompt,
